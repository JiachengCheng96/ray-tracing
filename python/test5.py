...
def main():
    ...
    mesh = o3d.geometry.TriangleMesh.create_cylinder(radius=0.5, height=2.0, resolution=500, split=10)
    ...
    plot_heatmap(total_heatmap, save_path=filename, title_str=f'Ray Hits per Pixel (samples_per_triangle={num_samples_per_source:.1E})', block=False)
    ...
    # Visualization Loop (Non-blocking to allow Matplotlib update)
    vis = o3d.visualization.Visualizer()
    vis.create_window(window_name="Forward Ray Tracing")
